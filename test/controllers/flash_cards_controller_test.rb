...
class FlashCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flash_card" do
    assert_difference("FlashCard.count") do
      post flash_cards_url, params: { flash_card: { description: @flash_card.description, name: @flash_card.name, topic_id: @flash_card.topic_id } }
    end
  ...
  test "should update flash_card" do
    patch flash_card_url(@flash_card), params: { flash_card: { description: @flash_card.description, name: @flash_card.name, topic_id: @flash_card.topic_id } }
